...
from tensorflow.keras.layers import Input, Conv2D, ReLU, Flatten, Dense, BatchNormalization, Reshape, Conv2DTranspose, Activation, Lambda
...
#print("diasbled eager execution")
